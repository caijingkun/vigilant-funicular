...
import matplotlib
matplotlib.use('Agg')
# ============ 中文字体适配（Windows / macOS / Linux / Streamlit Cloud 通用）============
from matplotlib import font_manager as _fm
def _setup_cjk_font():
    _candidates = [
        # Linux / Streamlit Cloud 可能存在的开源中文字体
        'Noto Sans CJK SC', 'Noto Sans SC', 'Noto Sans CJK JP',
        'WenQuanYi Micro Hei', 'WenQuanYi Zen Hei',
        'Source Han Sans CN', 'AR PL UMing CN', 'Droid Sans Fallback',
        # macOS 中文字体
        'PingFang SC', 'Heiti SC', 'Arial Unicode MS',
        # Windows 中文字体
        'SimHei', 'Microsoft YaHei',
        # 兜底（至少英文不崩，中文会显示方框但程序不报错）
        'DejaVu Sans',
    ]
